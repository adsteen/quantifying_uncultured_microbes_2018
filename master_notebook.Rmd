...
p_finebins <- ggplot(all_finebin, aes(x=numeric.bins, y=frac.seqs*100, colour = method)) + 
  ...
  scale_y_continuous(name = "Fraction of sequences (%)") + 
...
if(save.files) {
  ggsave("plots/resubmission/similarity_in_fine_bins_ColorBrewer.tiff", p_finebins, height = 4, width = 3.5, units = "in", dpi = 300)
...
if(save.files) {
  ...
  ggsave("plots/resubmission/arc_bac_boxplot.pdf", p_arc_bac_boxplot, height = 4, width = 7, units = "in", dpi = 300)
...
make_identity_plots <- function(df) {
  # p_bulk_identity <- ggplot(df, aes(x=envt.ordered, y = PctN, shape = method, colour = Environment_KL)) + 
    ...
    theme(axis.text.x = element_text(angle = -45, hjust = 0),
          ...
          legend.text = element_text(margin = margin(4, 4, 4, 4, "cm")),
          legend.position = "top") 
...
if(save.files) {
  ggsave("plots/resubmission/similarity_by_method_BW.png", p_all, height = 4, width = 3.5, units = "in", dpi = 300)
