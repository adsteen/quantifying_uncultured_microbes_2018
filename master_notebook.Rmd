...
if(save.files) {
  ggsave("plots/resubmission/similarity_in_fine_bins_ColorBrewer.tiff", p_finebins, height = 4, width = 3.5, units = "in", dpi = 900, compression = "lzw")
...
if(save.files) {
  ...
  ggsave("plots/resubmission/arc_bac_boxplot.tiff", p_arc_bac_boxplot, height = 4, width = 7, units = "in", dpi = 900, compression= "lzw")
